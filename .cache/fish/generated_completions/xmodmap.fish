...
complete -c xmodmap -o grammar -d 'This option indicates that a help message describing the expression grammar u…'
complete -c xmodmap -o version -d 'This option indicates that  xmodmap should print its version information and …'
complete -c xmodmap -o verbose -d 'This option indicates that  xmodmap should print logging information as it pa…'
complete -c xmodmap -o quiet -d 'This option turns off the verbose logging.   This is the default'
complete -c xmodmap -s n -d 'This option indicates that  xmodmap should not change the mappings, but shoul…'
