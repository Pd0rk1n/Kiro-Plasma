...
complete -c 'CA.pl.1ssl' -o sign -o xsign -d 'X Item "-sign, -xsign" Calls the openssl-ca\\|(1) command to sign a certificat…'
complete -c 'CA.pl.1ssl' -o signCA -d 'X Item "-signCA" This option is the same as the -sign option except it uses t…'
complete -c 'CA.pl.1ssl' -o signcert -d 'X Item "-signcert" This option is the same as -sign except it expects a self …'
