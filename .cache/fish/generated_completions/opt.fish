...
complete -c opt -o passes -d 'A textual (comma-separated) description of the pass pipeline, e. g'
...
complete -c opt -l save-stats -l save-stats -l save-stats -d 'Save LLVM statistics to a file in the current directory (--save-stats/"--save…'
