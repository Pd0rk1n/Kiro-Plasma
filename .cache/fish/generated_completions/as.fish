...
complete -c as -l emit-local-absolute -d 'X Item "--emit-local-absolute" Emit even pre-defined (local) absolute symbols…'
...
complete -c as -l gsframe-3 -d 'X Item "--gsframe-3" Generate SFrame stack trace information as per Version 3…'
...
complete -c as -l verbose -d 'X Item "--verbose" . PD Print the as version'
complete -c as -l version -d 'X Item "--version"'
complete -c as -o version -d 'X Item "-version" . PD Print the as version and exit'
...
complete -c as -o menable-sysreg-checking -d 'X Item "-menable-sysreg-checking" This option enables error messages that are…'
