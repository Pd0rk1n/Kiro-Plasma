...
complete -c chgrp -l reference -d 'use RFILE\'s ownership rather than specifying values'
complete -c chgrp -s R -l recursive -d 'operate on files and directories recursively '
complete -c chgrp -s H -d 'if a command line argument is a symlink to a directory, traverse it'
