...
complete -c cpupower-frequency-info -s b -l boost -d 'Gets the current boost state support'
complete -c cpupower-frequency-info -s z -l epp -d 'Gets the current EPP (energy performance preference)'
complete -c cpupower-frequency-info -s r -l related-cpus -d 'Determines which CPUs run at the same hardware frequency'
complete -c cpupower-frequency-info -s a -l affected-cpus -d 'Determines which CPUs need to have their frequency coordinated by software'
...
complete -c cpupower-frequency-info -s c -l performance -d 'Get performances and frequencies capabilities of CPPC, by reading it from har…'
