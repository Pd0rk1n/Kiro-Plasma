...
complete -c vim -o display -d 'Run  Vim on R {display} , connecting to that X server instead of the one in $…'
...
complete -c vim -l ttyfail -d 'When stdin or stdout is not a terminal (tty) then exit right away'
