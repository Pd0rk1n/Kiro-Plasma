...
complete -c openvpn -l ignore-unknown-option -d 'Valid syntax: NDENT 7. 0 NDENT 3. 5 . sp '
...
complete -c openvpn -l tmp-dir -d 'Specify a directory dir for temporary files instead of the default TMPDIR (or…'
...
complete -c openvpn -l comp-noadapt -d 'DEPRECATED This option does not have any effect anymore since current version…'
...
complete -c openvpn -l allow-deprecated-insecure-static-crypto -d 'DEPRECATED This allow using OpenVPN without TLS'
...
complete -c openvpn -l preresolve -d 'Resolve configured --remote, --local, --http-proxy, and --socks-proxy hostnam…'
...
complete -c openvpn -l max-clients -d 'Limit server to a maximum of n concurrent clients.  Defaults to 1024'
complete -c openvpn -l max-routes-per-client -d 'Allow a maximum of n internal routes per client (default 256)'
complete -c openvpn -l override-username -d 'Sets the username of a connection to the specified username'
...
complete -c openvpn -l show-groups -d '(Standalone) Show all available elliptic curves/groups to use with the --ecdh…'
...
complete -c openvpn -l crl-verify -d 'Check peer certificate against a Certificate Revocation List'
complete -c openvpn -l dh -d 'File containing finite field Diffie Hellman parameters in '
...
complete -c openvpn -l key -d 'Local peer\'s private key in . pem format or a URI'
complete -c openvpn -l ns-cert-type -d 'DEPRECATED The --remote-cert-tls option should be used instead'
...
complete -c openvpn -l tls-cipher -l tls-ciphersuites -d 'These options are expert features, which - if used correctly - can improve th…'
complete -c openvpn -l tls-client -d 'Enable TLS and assume client role during TLS handshake'
complete -c openvpn -l tls-crypt -d 'Encrypt and authenticate all control channel packets with the key from keyfile'
complete -c openvpn -l tls-crypt-v2 -d 'Valid syntax: NDENT 7. 0 NDENT 3. 5 . sp '
complete -c openvpn -l tls-crypt-v2-verify -d 'Run command cmd to verify the metadata of the client-specific tls-crypt-v2 ke…'
complete -c openvpn -l tls-crypt-v2-max-age -d 'Reject tls-crypt-v2 client keys that are older than n days or have no timesta…'
...
complete -c openvpn -l peer-fingerprint -d 'NDENT 7. 0 NDENT 3'
...
complete -c openvpn -l x509-username-field -d 'Fields in the X'
...
complete -c openvpn -l show-pkcs11-ids -d '(Standalone) Show PKCS#11 token object list. sp Valid syntax: NDENT 7'
complete -c openvpn -l up -d 'Please note the single quote marks and the escaping of the backslashes (\\\\) a…'
...
complete -c openvpn -l local -d 'Valid syntax: local host|* [port] [protocol] Local host name or IP address an…'
complete -c openvpn -l lport -d 'Set default TCP/UDP port number.  Cannot be used together with'
complete -c openvpn -l nobind -d 'achieve "bind() to a random assigned port number" if a bind-to IP address is …'
...
complete -c openvpn -l bind-dev -d '(Linux only) Set device to bind the server socket to a Virtual Routing and Fo…'
...
complete -c openvpn -l route-table -d 'Specify a default table id for use with --route'
...
complete -c openvpn -l tun-mtu-max -d 'This configures the maximum MTU size that a server can push to maxmtu, by con…'
...
complete -c openvpn -l dns-updown
...
complete -c openvpn -l disable-dco -d 'Disables the opportunistic use of data channel offloading if available'
complete -c openvpn -l fast-io -d 'Ignored since OpenVPN 2. 7'
complete -c openvpn -l http-proxy-retry -d 'Removed in OpenVPN 2. 4.   All retries are controlled by --max-connect-retry'
complete -c openvpn -l http-proxy-timeout -d 'Removed in OpenVPN 2. 4.   Connection timeout is controlled by'
...
complete -c openvpn -l max-routes -d 'Removed in OpenVPN 2. 4.   The limit was removed'
complete -c openvpn -l ncp-disable -d 'Removed in OpenVPN 2. 6'
complete -c openvpn -l no-iv -d 'Removed in OpenVPN 2. 5'
complete -c openvpn -l no-replay -d 'Removed in OpenVPN 2. 7'
complete -c openvpn -l prng -d 'Removed in OpenVPN 2. 6.   We now always use the PRNG of the SSL library'
complete -c openvpn -l persist-key -d 'Ignored since OpenVPN 2. 7.  Keys are now always persisted across restarts'
complete -c openvpn -l opt-verify -d 'Removed in OpenVPN 2. 7'
complete -c openvpn -l socks-proxy-retry -d 'Removed in OpenVPN 2. 4.   All retries are controlled by --max-connect-retry'
complete -c openvpn -l windows-driver -d 'Removed in OpenVPN 2. 7'
