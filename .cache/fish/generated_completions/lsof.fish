...
complete -c lsof -s J -d 'is mutually exclusive with  -j and  -t '
complete -c lsof -s j -d 'is mutually exclusive with  -J and  -t '
...
complete -c lsof -s t -d 'Warnings and errors are sent to stderr; stdout is always valid JSON (see CHAR…'
...
complete -c lsof -s P -d 'inhibits the conversion of port numbers to port names for network files (the …'
