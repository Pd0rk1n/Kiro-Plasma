...
complete -c xrandr -l delmonitor -d 'Delete the given user-defined monitor.  RandR version 1'
...
complete -c xrandr -l panning -d '[/track_widthxtrack_height+track_x+track_y [/border_left/border_top/border_ri…'
...
complete -c xrandr -l rate -d 'This marks a preference for refresh rates close to the specified value'
...
complete -c xrandr -l left-of -l right-of -l above
complete -c xrandr -l below -l same-as -d 'Use one of these options to position the output relative to the position of a…'
...
complete -c xrandr -s o -l orientation -d 'This specifies the orientation of the screen, and can be one of normal ,  inv…'
