...
complete -c mount -l map-groups -l map-users
...
complete -c mount -s r -l ro -l read-only
...
complete -c mount -o signer -o noattr -o binary -o outform -o out -d 'mount -o verity. hashdevice=/tmp/etc. verity,verity. roothashfile=/tmp/etc'
