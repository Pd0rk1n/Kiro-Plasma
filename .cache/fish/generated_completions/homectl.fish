...
complete -c homectl -l key-name -d 'When used with the add-signing-key command, specify or override the name unde…'
complete -c homectl -l seize -d 'Takes a boolean argument'
complete -c homectl -l prompt-new-user -d 'If used in conjunction with firstboot and no regular user account exists on t…'
complete -c homectl -l prompt-shell -d 'Takes a boolean argument'
complete -c homectl -l prompt-groups -d 'Takes a boolean argument'
complete -c homectl -l chrome -d 'Takes a boolean argument'
complete -c homectl -l mute-console -d 'Takes a boolean argument'
complete -c homectl -l match -s A -s N -s T -d 'Option --match= takes one of "this", "other", "any" or "auto"'
...
complete -c homectl -l default-area
...
complete -c homectl -l tmp-limit -l tmp-limit -l dev-shm-limit -l dev-shm-limit
