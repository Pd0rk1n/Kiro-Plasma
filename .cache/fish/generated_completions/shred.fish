...
complete -c shred -s v -l verbose -d 'show details of data and metadata operations performed'
complete -c shred -s x -l exact -d 'do not round file sizes up to the next full block; this is the default for no…'
