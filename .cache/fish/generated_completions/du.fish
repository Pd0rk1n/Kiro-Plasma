...
complete -c du -s A -l apparent-size -d 'print apparent sizes rather than device usage; although the apparent size is …'
complete -c du -s B -l block-size -d 'scale sizes by SIZE before printing them; See SIZE format below; E. g'
...
complete -c du -l time-style -d 'time/date format with --time; see TIME_STYLE below'
