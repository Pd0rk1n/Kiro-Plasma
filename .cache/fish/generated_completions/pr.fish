...
complete -c pr -o COLS -l columns -d 'output COLS columns and print columns down, unless -a is used'
complete -c pr -s a -l across -d 'print columns across rather than down, used together with -COLS'
