...
complete -c llc -s M -d 'Pass target-specific InstPrinter options'
...
complete -c llc -l save-stats -l save-stats -l save-stats -d 'Save LLVM statistics to a file in the current directory (--save-stats/"--save…'
