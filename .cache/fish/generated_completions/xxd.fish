...
complete -c xxd -s R -d 'In the output both the data column (hex, or bits with -b) and the character c…'
...
complete -c xxd -s t -d 'When outputting in C include file style using -i include the terminating zero'
