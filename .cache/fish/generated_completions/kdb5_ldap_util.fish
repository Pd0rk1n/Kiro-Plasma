...
complete -c kdb5_ldap_util -o maxtktlife -d '(%getdate time string) Specifies maximum ticket life for principals in this r…'
complete -c kdb5_ldap_util -o maxrenewlife -d '(%getdate time string) Specifies maximum renewable life of tickets for princi…'
