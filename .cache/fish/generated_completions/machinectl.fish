...
complete -c machinectl -s P -d 'Equivalent to --value --property=, i. e'
...
complete -c machinectl -l runner -d 'When operating on machines choose whether to use systemd-nspawn(1) or systemd…'
complete -c machinectl -s V -d '-V is a shorthand for --runner=vmspawn. sp Added in version 256'
complete -c machinectl -l now -d 'When used with enable or disable, the containers will also be started or powe…'
complete -c machinectl -l force -d 'Replace target file when copying files. sp Added in version 219'
...
complete -c machinectl -l bind-volume -d 'argument of systemd-vmspawn(1)'
complete -c machinectl -o p/--property
