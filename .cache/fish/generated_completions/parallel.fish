...
complete -c parallel -l basefile -d 'X Item "--basefile file (beta testing)"'
complete -c parallel -l bf -d 'X Item "--bf file (beta testing)" '
...
complete -c parallel -l block -d 'X Item "--block size (beta testing)"'
complete -c parallel -l block-size -d 'X Item "--block-size size (beta testing)" '
...
complete -c parallel -l cat -d 'X Item "--cat (beta testing)" Create a temporary file with content'
complete -c parallel -l cleanup -d 'X Item "--cleanup (beta testing)" Remove transferred files'
...
complete -c parallel -s d -d 'X Item "-d delim" . PD Input records are terminated by delim'
...
complete -c parallel -l dry-run -d 'X Item "--dry-run (beta testing)" Print the job to run on stdout (standard ou…'
...
complete -c parallel -l env -d 'X Item "--env var (alpha testing)" Copy exported environment variable var'
...
complete -c parallel -l fast -d 'X Item "--fast (alpha testing)" Run jobs fast'
complete -c parallel -o E/--eof -d 'X Item "-E/--eof: end-of-file string not implemented. " . RE . RS 4 '
complete -c parallel -l group -d 'X Item "--group (default): output is grouped per chunk (several jobs)'
complete -c parallel -l halt/--halt-on-error -l halt -l halt -d 'X Item "--halt/--halt-on-error: failure detection is per chunk, so it will no…'
complete -c parallel -l joblog/--jl -d 'X Item "--joblog/--jl: Command lines longer than 4 KB may be truncated. "'
complete -c parallel -l timeout -d 'X Item "--timeout: applies to each chunk of jobs, not each individual job. "'
complete -c parallel -l bar/--eta/--progress -d 'X Item "--bar/--eta/--progress: the inner parallel counts chunks, not individ…'
complete -c parallel -l retries -d 'X Item "--retries: These will retry the whole group of jobs. "'
complete -c parallel -l load/--limit/--memfree/--noswap -d 'X Item "--load/--limit/--memfree/--noswap: These will retry the whole group o…'
complete -c parallel -l results/-o -d 'X Item "--results/-o: no per-job output file support. "'
complete -c parallel -l tty -d 'X Item "--tty: jobs inherit /bin/sh\'s stdin (a pipe), not a terminal. "'
complete -c parallel -o L/--max-lines/-l -d 'X Item "-L/--max-lines/-l: multi-line records not supported. "'
complete -c parallel -l verbose/-t -d 'X Item "--verbose/-t: echoing commands to stderr not implemented. "'
complete -c parallel -l total-jobs -d 'X Item "--total-jobs: total job count is not known ahead of time. " . PD '
complete -c parallel -l pipe/--pipepart/--tee/--fifo/--cat/--header/--group-by -d 'X Item "--pipe/--pipepart/--tee/--fifo/--cat/--header/--group-by: separate ex…'
complete -c parallel -l sshlogin -l sshloginfile/--slf -l basefile/--bf -l transfer -l return -l trc -l filter-hosts -l workdir -l hostgroups -d 'X Item "SSH/remote options (--sshlogin, --sshloginfile/--slf, --basefile/--bf…'
complete -c parallel -l tmux/--tmuxpane/--bg/--fg/--wait/--semaphore -d 'X Item "--tmux/--tmuxpane/--bg/--fg/--wait/--semaphore: separate execution mo…'
complete -c parallel -l fg -d 'X Item "--fg" Run command in foreground'
complete -c parallel -l fifo -d 'X Item "--fifo (alpha testing)" Create a temporary fifo with content'
complete -c parallel -l filter -d 'X Item "--filter filter (alpha testing)" Only run jobs where filter is true'
complete -c parallel -l gnu -d 'X Item "--gnu" Behave like GNU parallel'
complete -c parallel -l group-by -d 'X Item "--group-by val (alpha testing)" Group input by value'
...
complete -c parallel -l keep-order -d 'X Item "--keep-order (alpha testing)"'
complete -c parallel -s k -d 'X Item "-k (alpha testing)" '
...
complete -c parallel -l ll -d 'X Item "--ll" . PD Print the latest line'
...
complete -c parallel -s M -d 'X Item "-M" . PD Use ssh\\*(Aqs ControlMaster to make ssh connections faster'
complete -c parallel -s m -d 'X Item "-m" Multiple arguments'
complete -c parallel -l match -d 'X Item "--match regexp" Match input source with regexp to set replacement fie…'
complete -c parallel -l memfree -d 'X Item "--memfree size" Minimum memory free when starting another job'
complete -c parallel -l memsuspend -d 'X Item "--memsuspend size" Suspend jobs when there is less memory available'
complete -c parallel -l milestone -d 'X Item "--milestone str" Set milestones where all previous jobs must have fin…'
...
complete -c parallel -l pipe -d 'X Item "--pipe (beta testing)"'
complete -c parallel -l spreadstdin -d 'X Item "--spreadstdin (beta testing)" '
complete -c parallel -l pipe-part -d 'X Item "--pipe-part (alpha testing)" Pipe parts of a physical file'
...
complete -c parallel -l round-robin -d 'X Item "--round-robin (alpha testing)"'
complete -c parallel -l round -d 'X Item "--round (alpha testing)" '
...
complete -c parallel -l ssh -d 'X Item "--ssh sshcommand (alpha testing)" GNU parallel defaults to using ssh …'
...
complete -c parallel -l sshloginfile -d 'X Item "--sshloginfile filename (beta testing)"'
complete -c parallel -l slf -d 'X Item "--slf filename (beta testing)" . PD File with sshlogins'
...
complete -c parallel -l tee -d 'X Item "--tee (alpha testing)" Pipe all data to all jobs'
...
complete -c parallel -l tmux -d 'X Item "--tmux (alpha testing)" Use tmux for output'
complete -c parallel -l tmuxpane -d 'X Item "--tmuxpane (alpha testing)" Use tmux for output but put output into p…'
...
complete -c parallel -l transferfile -d 'X Item "--transferfile filename (beta testing)"'
...
complete -c parallel -l unsafe -d 'X Item "--unsafe" GNU parallel tries to be conservative to avoid surprising r…'
...
complete -c parallel -l null/-0 -o d/--delimiter -l colsep/-C
complete -c parallel -l link/:::+/::::+
