...
complete -c glances -l print-completion -d 'generate shell tab completion scripts for Glances CLI'
...
complete -c glances -l browser -d 'start TUI Central Glances Browser use âbrowser -w to start WebUI Central Gl…'
...
complete -c glances -l enable-mcp -d 'enable the MCP (Model Context Protocol) server alongside the web server (mcp …'
complete -c glances -l mcp-path -d 'set the MCP server mount path [default: /mcp]'
