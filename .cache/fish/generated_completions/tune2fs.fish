...
complete -c tune2fs -s c -d 'Adjust the number of mounts after which the file system will be checked by e2…'
...
complete -c tune2fs -s Q -d 'Sets the quota feature on the superblock and works on the quota files for the…'
...
complete -c tune2fs -s U -d 'Set the universally unique identifier (UUID) of the file system to UUID'
