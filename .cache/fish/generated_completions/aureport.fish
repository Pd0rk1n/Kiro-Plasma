...
complete -c aureport -l delete -d 'When used with configuration, integrity, or MAC reports, only include delete …'
...
complete -c aureport -l add -d 'When used with configuration, integrity, or MAC reports, only include add or …'
