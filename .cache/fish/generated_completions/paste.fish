...
complete -c paste -s d -l delimiters -d 'reuse characters from LIST instead of TABs; backslash escapes are supported'
complete -c paste -s s -l serial -d 'paste one file at a time instead of in parallel; the newline of every line ex…'
