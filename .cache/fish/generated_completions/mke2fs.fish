...
complete -c mke2fs -s C -d 'Specify the size of clusters in bytes for file systems using the bigalloc fea…'
complete -c mke2fs -s d -d 'Copy the contents of the given directory or tarball into the root directory o…'
...
complete -c mke2fs -s F -d 'Force mke2fs to create a file system, even if the specified device is not a p…'
...
complete -c mke2fs -s l -d 'Read the bad blocks list from filename'
complete -c mke2fs -s L -d 'Set the volume label for the file system to new-volume-label'
...
complete -c mke2fs -s n -d 'Causes mke2fs to not actually create a file system, but display what it would…'
...
complete -c mke2fs -s O -d 'Create a file system with the given features (file system options), overridin…'
...
complete -c mke2fs -s T -d 'Specify how the file system is going to be used, so that mke2fs can choose op…'
complete -c mke2fs -s U -d 'Set the universally unique identifier (UUID) of the file system to UUID'
complete -c mke2fs -s v -d 'Verbose execution'
complete -c mke2fs -s V -d 'Print the version number of mke2fs and exit'
complete -c mke2fs -s R -d 'in earlier versions of mke2fs'
